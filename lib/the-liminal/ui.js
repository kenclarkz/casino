...
export class UI {
  ...
  build() {
    ...
    const ctrlContent = isMobile
      ? `<div class="tl-menu-title tl-pause-title">CONTROLS</div>
      <div class="tl-settings-body tl-controls">
        <p><b>Left stick</b> move &nbsp; <b>Right stick</b> look around</p>
        <p><b>Sword icon</b> attack &nbsp; <b>Crosshair</b> aim (guns)</p>
        <p><b>&raquo;</b> run &nbsp; <b>▼</b> crouch (stealth) &nbsp; <b>+</b> heal</p>
        <p><b>E</b> interact &nbsp; <b>🔦</b> flashlight &nbsp; <b>↻</b> reload</p>
        <p><b>🎒</b> inventory / craft &nbsp; <b>⇌</b> swap weapon &nbsp; <b>❚❚</b> pause</p>
    ...
    ctrl.innerHTML = ctrlContent + `<div class="tl-menu-buttons"><button data-act="back-controls">BACK</button></div>`
  ...
  promptText(key) {
    ...
    let t = key
    for (const [k, v] of Object.entries(map)) t = t.replace(k, v)
    return t
  }
